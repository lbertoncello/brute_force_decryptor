...
public class SlaveThread implements Runnable {
    ...
    public SlaveThread(Slave slave, byte[] ciphertext, byte[] knowntext, long initialwordindex, long finalwordindex, int attackNumber, SlaveManager callbackinterface) {
        this.slave = slave;
